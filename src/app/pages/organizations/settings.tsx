      ...
      return (
        <div>
          <Nav
            className="mb-3"
            variant="tabs"
            defaultActiveKey={this.props.match.params.settingsSection || "home"}
          >
            <Nav.Item>
              <Link
                className="nav-link"
                to={`/organizations/${organization.login}/settings`}
              >
                Home
              </Link>
            </Nav.Item>
            <Nav.Item>
              <Link
                className="nav-link"
                to={`/organizations/${organization.login}/settings/statuses`}
              >
                Statuses
              </Link>
            </Nav.Item>
            <Nav.Item>
              <Link
                className="nav-link"
                to={`/organizations/${organization.login}/settings/labels`}
              >
                Labels
              </Link>
            </Nav.Item>
            <Nav.Item>
              <Link
                className="nav-link"
                to={`/organizations/${organization.login}/settings/people`}
              >
                People
              </Link>
            </Nav.Item>
          ...
          <Switch>
            <Route
              path={`/organizations/:login/settings/statuses`}
              component={StatusesPage}
            />
            <Route
              path={`/organizations/:login/settings/labels`}
              component={LabelsPage}
            />
            <Route
              path={`/organizations/:login/settings/people`}
