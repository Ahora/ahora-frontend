import { ADD_LABEL, LabelActionTypes, DELETE_LABEL, UPDATE_LABEL, REQUEST_LABEL, LABEL_USED } from './types'
...
export const updateLabelUsedInStore = (id: number): LabelActionTypes => ({ type: LABEL_USED, payload: id });