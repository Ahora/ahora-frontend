...
import { SET_URRENT_ORGANIZATION, SET_SEARCH_CRITERIAS, RECIEVED_UNREAD_NUMBER, FETCH_UNREAD_NUMBER, REDUCE_UNREAD_COUNT } from './types';
import { OrganizationTeamUser } from 'app/services/organizationTeams';
import { SearchCriterias } from 'app/components/SearchDocsInput';

export const setCurrentOrganization = (org: Organization, orgPermission?: OrganizationTeamUser) => ({ type: SET_URRENT_ORGANIZATION, data: { currentOrganization: org, currentOrgPermission: orgPermission } });
